...
include('../app/controllers/cotizar/listadeCotizaciones.php');
                    ...
                    foreach($pedidos_tabla as $pedido_dato){ 
                     ...
                     <tr >
                       ...
                       <td ><?php echo $pedido_dato['Mensaje_Vendedor'];?></td>
                        <td >
                              <div class="btn-group">
                              <a href="EditarCotizacion.php?id=<?php echo $ID_Cotizar;?> " type="button" class="btn btn-success"><i class="fa fa-pen"></i>Escribir Mensaje</a>
                              <!-- <a href="EliminarCotizacion.php?id=<?php echo $ID_Cotizar;?> " type="button" class="btn btn-danger"><i class="fa fa-trash"></i>Eliminar Pedido</a> -->
