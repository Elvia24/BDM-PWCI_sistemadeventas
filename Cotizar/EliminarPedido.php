...
include('../app/controllers/cotizar/cargar_pedido.php');
...
<div class="card card-row card-default">
        ...
        <form class="form-horizontal" action="../app/controllers/cotizar/eliminar_mensaje.php " method="POST"  enctype="multipart/form-data"   >

            <div class="card-body">
                <div class="card card-light card-outline">
                

                <input name="id_pedido" type="text" value="<?php echo $id_pedido_get ?>" hidden>
