...
include('../app/controllers/filtros/mas_vendidos.php');
...
<div class=" content-wrapper "style="background-color: var(--gris-bisonte);">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><a href="../Productos/Productos.php" type="button" class="btn btn-info"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a>Mas/Menos Vendido</h1>
